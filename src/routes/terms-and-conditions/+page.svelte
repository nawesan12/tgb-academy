<svelte:head>
  <title>Terminos y Condiciones | TGB Academy</title>
</svelte:head>

Esta política de condiciones de uso es válida a partir del Dec 2023.
TÉRMINOS Y CONDICIONES — Gorosito Studio
Gorosito Studio, persona jurídica de derecho privado describe, a través de este documento, las normas de uso del sitio https://gorositostudio.com y de cualquier otro sitio web, tienda o aplicación operada por el titular.
...
El uso de este sitio web implica la adhesión a estas Condiciones de Uso y a la versión más actualizada de la Política de Privacidad de Gorosito Studio.

Sección 3 - Condiciones de acceso
En general, el acceso al sitio web de Gorosito Studio es gratuito y no requiere registro previo.
...
Algunas partes de este sitio web ofrecen al usuario la opción de publicar comentarios en determinadas áreas.Gorosito Studio no consiente la publicación de contenidos de carácter discriminatorio, ofensivo o ilícito, o que infrinjan los derechos de autor o cualquier otro derecho de terceros.

La publicación de cualquier contenido por parte del usuario de este sitio web, incluidos los mensajes y comentarios, implica una licencia no exclusiva, irrevocable e irreversible para su uso, reproducción y publicación por parte de Gorosito Studio en su sitio web, plataformas de internet y aplicaciones, o incluso en otras plataformas, sin ninguna restricción o limitación.
...
Todos los elementos de Gorosito Studio son propiedad intelectual de la misma o de sus licenciantes. Estos términos o el uso del sitio web no le otorgan ninguna licencia o derecho de uso de los derechos de propiedad intelectual de Gorosito Studio o de cualquier tercero.
...
La totalidad del sitio web o cada una de sus secciones podrá ser cerrada, suspendida o interrumpida unilateralmente por Gorosito Studio, en cualquier momento y sin previo aviso.

Sección 8 - Datos personales
Durante el uso de este sitio web, ciertos datos personales serán recogidos y procesados por Gorosito Studio y/o los Socios. Las normas relativas al tratamiento de los datos personales de Gorosito Studio están estipuladas en la Política de Privacidad.

Sección 9 - Contacto
Si tiene alguna pregunta sobre las condiciones de uso, por favor póngase en contacto con nosotros por correo electrónico gorositostudio@gmail.com.